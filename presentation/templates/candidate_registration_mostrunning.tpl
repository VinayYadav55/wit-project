{load_presentation_object filename='candidate_registration' assign='obj'}
...
<script>
 ...
 gtag('config', 'UA-147066526-1');
    ...
    <link rel="stylesheet" type="text/css" href="{base_url()}/styles/candidate_registration.css?v={jsversion()}" />
...
<body>
            ...
            <div class="col-md-6 offset-sm-3 py-2">
                <form action="#">
                    <div class="form-group">
                        <input type="hidden" class="applicantid" id="{$userSessionDetail.id}">
                    </div>
                    <div class="form-group">
    ...
    <script src="{base_url()}/js/candidate_registration.js?v={jsversion()}"></script>
