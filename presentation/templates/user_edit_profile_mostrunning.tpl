    ...
    >
      ...
      <div class="mt-3  pl-3">
        <nav class="nav flex-column nav-pills">
          ...
          <a class="nav-link active" href="{base_url()}/user_edit_profile"
            >Edit Profile</a
          >
        </nav>
      </div>
                  ...
                  <form action="#">
                    <div class="form-group">
                      ...
                      >
                        ...
                        <option value="Bangalore" {if in_array('Bangalore',$preferedCity)}selected{/if}>Bangalore</option
                        ><option value="Chennai" {if in_array('Chennai',$preferedCity)}selected{/if}>Chennai</option>
                        <option value="Pune" {if in_array('Pune',$preferedCity)}selected{/if}>Pune</option>
                        <option value="Kolkatta" {if in_array('Kolkatta',$preferedCity)}selected{/if}>Kolkatta</option
                        ><option value="Mumbai" {if in_array('Mumbai',$preferedCity)}selected{/if}>Mumbai</option
                        ><option value="Jaipur" {if in_array('Jaipur',$preferedCity)}selected{/if}>Jaipur</option
                        ><option value="Indore" {if in_array('Indore',$preferedCity)}selected{/if}>Indore</option
                        ><option value="Lucknow" {if in_array('Lucknow',$preferedCity)}selected{/if}>Lucknow</option
                        ><option value="Goa" {if in_array('Goa',$preferedCity)}selected{/if}>Goa</option>
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      {assign var = 'prefered_job_types' value=$candidateDetail.prefered_job_types_array}
                        <option value="Full Time" {if in_array('Full Time',$prefered_job_types)}selected{/if}>Full Time</option>
                        <option value="Part Time" {if in_array('Part Time',$prefered_job_types)}selected{/if}>Part Time</option>
                        <option value="Remote Working" {if in_array('Remote Working',$prefered_job_types)}selected{/if}>Remote Working</option>
                        <option value="Consultant" {if in_array('Consultant',$prefered_job_types)}selected{/if}>Consultant</option
                        ><option value="Volunteer" {if in_array('Volunteer',$prefered_job_types)}selected{/if}>Volunteer</option>
                        <option value="Paid Internship" {if in_array('Paid Internship',$prefered_job_types)}selected{/if}>Paid Internship</option>
                        <option value="Unpaid Internship" {if in_array('Unpaid Internship',$prefered_job_types)}selected{/if}>Unpaid Internship</option>
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select
                        ...
                        <option value="Art Director / Graphic / Web Designer" {if in_array('Art Director / Graphic / Web Designer',$functional_area)}selected{/if}>Art Director / Graphic / Web Designer</option>
                        <option value="Audit" {if in_array('Audit',$functional_area)}selected{/if}>Audit</option>
                        <option value="Accounting / finance" {if in_array('Accounting / finance',$functional_area)}selected{/if}>Accounting / finance</option>
                        <option value="Computer Operator / Data Entry" {if in_array('Computer Operator / Data Entry',$functional_area)}selected{/if}>Computer Operator / Data Entry</option>
                        <option value="Database Administrator / Data Warehouse" {if in_array('Database Administrator / Data Warehouse',$functional_area)}selected{/if}>Database Administrator/Data Warehouse</option>
                        <option value="Digital Marketing / SEM / SEO" {if in_array('Digital Marketing / SEM / SEO',$functional_area)}selected{/if}>Digital Marketing / SEM / SEO</option>
                        <option value="HR" {if in_array('HR',$functional_area)}selected{/if}>HR</option>
                        <option value="Management" {if in_array('Management',$functional_area)}selected{/if}>Management</option>
                        <option value="Network Administrator" {if in_array('Network Administrator',$functional_area)}selected{/if}>Network Administrator</option>
                        <option value="Operations" {if in_array('Operations',$functional_area)}selected{/if}>Operations</option>
                        <option value="Project Management" {if in_array('Project Management',$functional_area)}selected{/if}>Project Management</option>
                        <option value="WebDesigner / UI / UX Designer" {if in_array('WebDesigner / UI / UX Designer',$functional_area)}selected{/if}>WebDesigner / UI / UX Designer</option>
                        <option value="Software Testing" {if in_array('Software Testing',$functional_area)}selected{/if}>Software Testing</option>
                        <option value="Sales / Marketing" {if in_array('Sales / Marketing',$functional_area)}selected{/if}>Sales / Marketing </option>
                        <option value="Software Development" {if in_array('Software Development',$functional_area)}selected{/if}>Software Development</option>
                        <option value="Others" {if in_array('Others',$functional_area)}selected{/if}>Others</option>
                      </select>
                    </div>
                    {assign var = 'industry_type' value=$candidateDetail.industry_type_array}
                    <div class="form-group">
                      ...
                      <select
                        ...
                        style="width: 100% !important; border:none;"
                      >
                    <option value="Accounting / Finance" {if in_array('Accounting / Finance',$industry_type)}selected{/if}>Accounting / Finance</option>
                    <option value="Banking / Financial Services" {if in_array('Banking / Financial Services',$industry_type)}selected{/if}>Banking / Financial Services</option>
                    <option value="IT- Hardware and Networking" {if in_array('IT- Hardware and Networking',$industry_type)}selected{/if}>IT- Hardware and Networking</option>
                    <option value="Medical / Healthcare" {if in_array('Medical / Healthcare',$industry_type)}selected{/if}>Medical / Healthcare</option>
                    <option value="Telecom / ISP" {if in_array('Telecom / ISP',$industry_type)}selected{/if}>Telecom / ISP</option>
                    <option value="Recruitment / Staffing" {if in_array('Recruitment / Staffing',$industry_type)}selected{/if}>Recruitment / Staffing</option>
                    <option value="KPO, Research, Analytics" {if in_array('KPO, Research, Analytics',$industry_type)}selected{/if}>KPO, Research, Analytics</option>
                    <option value="Internet, E-commerce" {if in_array('Internet, E-commerce',$industry_type)}selected{/if}>Internet, E-commerce</option>
                    <option value="IT-Software, Software Services" 
                    {if in_array('IT-Software, Software Services',$industry_type)}selected{/if}>IT-Software, Software Services</option>
                    <option value="Education, Teaching, Training" {if in_array('Education, Teaching, Training',$industry_type)}selected{/if}>Education, Teaching, Training</option>
                    <option value="Others" {if in_array('Others',$industry_type)}selected{/if}>Others</option>
                    </select>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        >{assign var = 'experience' value=$candidateDetail.experience}
                          <option disabled="disabled" selected="true"
                            >Select</option
                          >
                          <option value="0-3" {if '0-3'==$experience}selected{/if}>0-3 Year</option>
                          <option value="3-6" {if '3-6'==$experience}selected{/if}>3-6 Year</option>
                          <option value="6-10" {if '6-10'==$experience}selected{/if}>6-10 Year</option>
                          <option value="10+" {if '10+'==$experience}selected{/if}>10+ Year</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="accordion py-5" id="accordionExample">
                          ...
                          <div class="card-body">
                            <details class="mt-3">
                              <summary
                                ...
                                >10th</summary
                              >
                              {assign var='class_10_details' value=$candidateDetail.educationDetails[0]}
                              ...
                              <div class="form-group employeehighschoolrecord">
                                ...
                                <input
                                  ...
                                  value="{$class_10_details.BoardName}"
                              ...
                              <div class="form-group employeehighschoolrecord">
                                ...
                                <input
                                  ...
                                  placeholder="DPS etc"
                                  value="{$class_10_details.schoolName}"
                                />
                              </div>
                              <div class="form-group employeehighschoolrecord">
                                ...
                                <input
                                  ...
                                  value="{$class_10_details.passingYear}"
                                />
                              </div>
                              <div class="form-group employeehighschoolrecord">
                            ...
                            <details class="mt-3">
                              <summary
                                ...
                                >12th</summary
                              >
                              {assign var='class_12_details' value=$candidateDetail.educationDetails[1]}
                              <div
                              ...
                              >
                                ...
                                <input
                                  ...
                                  placeholder="C.B.S.E etc"
                                  value="{$class_12_details.BoardName}"
                                />
                              </div>
                              <div
                                class="form-group employeehighersecondaryrecord"
                              >
                                ...
                                <input
                                  ...
                                  placeholder="DPS etc"
                                  value="{$class_12_details.schoolName}"
                                />
                              </div>
                              <div
                                class="form-group employeehighersecondaryrecord"
                              >
                                ...
                                <input
                                  ...
                                  placeholder="2002 etc"
                                  value="{$class_12_details.passingYear}"
                                />
                              </div>
                              <div
                                class="form-group employeehighersecondaryrecord"
                            ...
                            <details class="mt-3">
                              ...
                              <div class="form-group">
                                ...
                                <input
                                  ...
                                  value="{$grd_details.Specilization}"
                                />
                              </div>
                              <div class="form-group">
                                <label for="">Year of Complition</label>
                                <input
                                  ...
                                  value="{$grd_details.Year_of_Complition}"
                                />
                              </div>
                              <div class="form-group">
                            ...
                            <details class="mt-3">
                              ...
                              <div class="form-group">
                                ...
                                <input
                                  ...
                                  placeholder="Finance etc"
                                  value="{$pg_details.Specilization}"
                                />
                              </div>
                              <div class="form-group">
                                <label for="">Year of Complition</label>
                                <input
                                  ...
                                  placeholder="2011 etc"
                                  value="{$pg_details.Year_of_Complition}"
                                />
                              </div>
                              <div class="form-group">
                                <label for="">Percentage / CGPA/ GPA</label>
                            ...
                            <details class="mt-3">
                              {assign var='other_class_details' value=$candidateDetail.educationDetails[4]}
                              <summary
                                class="bg-light"
                                style="border: 1px solid #e6e4e4;outline: none; box-shadow: none;"
                              ...
                              <div class="form-group">
                                ...
                                <input
                                  ...
                                  placeholder="Phd etc"
                                  value="{$other_class_details.course}"
                                />
                              </div>
                              <div class="form-group">
                                <label for="">Specilization</label>
                          ...
                          <div class="card-body">
                            <div class="form-group">
                              ...
                              {assign var="skillset" value=$candidateDetail.skill_set_array}
                                <option value="HTML" {if in_array('HTML', $skillset)}selected{/if}>HTML</option>
                                <option value="CSS" {if in_array('CSS', $skillset)}selected{/if}>CSS</option>
                                <option value="JavaScript" {if in_array('JavaScript', $skillset)}selected{/if}>JavaScript</option>
                                <option value="Java" {if in_array('Java', $skillset)}selected{/if}>Java</option
                                ><option value="NodeJs" {if in_array('NodeJs', $skillset)}selected{/if}>NodeJs</option
                                ><option value="Angular2+" {if in_array('Angular2', $skillset)}selected{/if}>Angular2+</option
                                ><option value="AngularJs" {if in_array('AngularJs', $skillset)}selected{/if}>AngularJs</option
                                ><option value="JQuery" {if in_array('JQuery', $skillset)}selected{/if}>JQuery</option
                                ><option value="Python" {if in_array('Python', $skillset)}selected{/if}>Python</option
                                ><option value="BigData" {if in_array('BigData', $skillset)}selected{/if}>Big Data</option
                                ><option value="DataScience" {if in_array('DataScience', $skillset)}selected{/if}
                                  >Data Science</option
                                >
                              </select>
                            </div>
                          ...
                          <div class="card-body">
                            <details class="mt-3">
                              <summary
                                ...
                                >Project 1</summary
                              >
                              {assign var='project_1_details' value=$candidateDetail.projectDetails[0]}
                              <div class="form-group">
                            ...
                            <details class="mt-3">
                              <summary
                                ...
                                style="border: 1px solid #e6e4e4; outline: none; box-shadow: none;"
                                >Project 2</summary
                              >{assign var='project_2_details' value=$candidateDetail.projectDetails[1]}
                              <div class="form-group">
                                <label for="">Project Title</label>
                                <input
                                  type="text"
                            ...
                            <details class="mt-3">
                              <summary
                                ...
                                >Project 3</summary
                              >
                              {assign var='project_3_details' value=$candidateDetail.projectDetails[2]}
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group col-6">
                              ...
                              >
                                ...
                                <option value="Single/Unmarried" {if 'Single/Unmarried'==$candidateDetail.martial_status}selected{/if}>Single/Unmarried</option>
                                <option value="Married" {if 'Married'==$candidateDetail.martial_status}selected{/if}>Married</option>
                              </select>
                            </div>      
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              >{$candidateDetail.permanent_address}</textarea>
                            </div>
                            <div class="form-row">
                            <div class="form-group col-6">
                      ...
                      >
                        ...
                        <input
                          ...
                          id="watch-me"
                          value = 'Yes' {if 'Yes'==$candidateDetail.currently_working_status}checked{/if}}
                        />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp;
                        <label for="">No</label>
                        <input
                          ...
                          name="workingcurrently"
                          id="jhjyg"
                          value = 'No' {if 'Yes'==$candidateDetail.currently_working_status}checked{/if}}
                          checked
                        />
                      </div>
                            ...
                            >
                              ...
                              <div class="form-group">
                                ...
                                <textarea
                                  ...
                                  rows="2"
                                  id="comment" 
                                >{$candidateDetail.current_job_descripton}</textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="card-body employmentDetailsDiv">
                            ...
                            <details class="mt-3">
                              <summary
                                ...
                                style="border: 1px solid #e6e4e4; outline: none; box-shadow: none;"
                                >job1</summary
                              >{assign var='job_1_details' value=$candidateDetail.previousJobDetails[0]}
                              ...
                              >
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea
                                    ...
                                    rows="2"
                                    id="comment"
                                  > {$job_1_details.description}</textarea>
                                </div>
                              </div>
                            </details>
                            ...
                            <details class="mt-3">
                              <summary
                                ...
                                style="border: 1px solid #e6e4e4; outline: none; box-shadow: none;"
                                >job2</summary
                              >{assign var='job_2_details' value=$candidateDetail.previousJobDetails[1]}
                              ...
                              <div class="col-sm-6 form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea
                                    ...
                                    rows="2"
                                    id="comment"
                                  > {$job_2_details.description}</textarea>
                                </div>
                              </div>
                            </details>
                            ...
                            <details class="mt-3">
                              <summary
                                ...
                                style="border: 1px solid #e6e4e4; outline: none; box-shadow: none;"
                                >job3</summary
                              >{assign var='job_3_details' value=$candidateDetail.previousJobDetails[2]}
                              ...
                              <option value="1990"
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea
                                    ...
                                    rows="2"
                                    id="comment"
                                  >{$job_3_details.description}</textarea>
                                </div>
                              </div>
                            </details>
                          </div>
