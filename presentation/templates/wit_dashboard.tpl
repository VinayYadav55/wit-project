{load_presentation_object filename='witAdmin' assign='obj'}
    ...
    <div class="mt-5 pt-5 pl-3">
      <nav class="nav flex-column nav-pills">
        <a class="nav-link active" href="{base_url()}/dashboard">Dashboard</a>
           <a class="nav-link" href="{base_url()}/mentors">Mentor List</a>
      </nav>
    </div>
  </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-capitalize">
                          <a
                            href="{base_url()}/wit_view_company_full_detail/company_id={$companyData.id}">{$companyData.company_name}</a>
                        </td>
                      </tr>
                      {/foreach}
                    </tbody>
