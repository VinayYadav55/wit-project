...
<body>
  ...
  <div style="margin-top: 7.7rem !important;">
    ...
    <div class="container">
      <div class="row no-gutters">
        <div class="col-sm-12">
          <div class="table-responsive">
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  <td class="text-center">10:20-10:45</td>

                  <td class="text-center bgfirst" rowspan=3>
                    <span class="badge badge-light float-right">{$obj->classesTotalCount[0].machine} / 40</span>
          ...
          <td class="text-center bgSecond" rowspan="2">
            <span class="badge badge-light float-right">{$obj->classesTotalCount[0].idealmentor} / 40</span>
        ...
        <tr>
          <td class="text-center">10:45-11:00</td>
        </tr>
        <tr>
          <td class="text-center"><br>11:00-11:45</td>
          <td class="text-center bgSecond">
            <span class="badge badge-light float-right">{$obj->classesTotalCount[0].speedmentoring} / 40</span>
      ...
      <tr>
        <td class="text-center"><br>12:00-12:45</td>
        <td class="text-center bgfirst">
          <span class="badge badge-light float-right">{$obj->classesTotalCount[0].datascience} / 40</span>
    ...
    {/if}
    <p class="text-white">Data Science: Beyond the Hype</p>
    </td>
    <td class="text-center bgSecond">
      <span class="badge badge-light float-right">{$obj->classesTotalCount[0].selfimage} / 40</span>
  ...
  {/if}
  <p class="text-white">Creating a stronger self image</p>
  </td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="text-center">01:00-01:30</td>
  </tr>
  <tr class="text-center text-danger">
    <td>01:30-02:15</td>
    <td>45 Mins</td>
  ...
  <div class="col-sm-4 offset-sm-4 py-5">
    ...
    <div class="col-sm-4 offset-sm-4 text-center my-5">
        <a class="btn btn-secondary px-5 skiptoclass">Skip</a>
    </div>
  </div>
  </div>
  </div>
