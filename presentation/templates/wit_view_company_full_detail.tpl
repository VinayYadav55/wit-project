...
<head>
  ...
  <link href="{base_url()}/styles/wit_dashboard.css?v={jsversion()}" rel="stylesheet" />
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="{base_url()}/job_full_detail/job_id={$job.id}">{$job.job_title}</a>
                    </td>
                    <td class={if $job.active_status==='Active' }text-success{else}text-dark{/if}>{$job.active_status}
                      </td> <td>
                      <a href="{base_url()}/job_applicants/job_id={$job.id}"> {$job.applicant_count}&nbsp;(view)</a>
                    </td>
