          ...
          <div class="col-sm-12 bg-light  p-5 colRadius">
            <div class="row ">
              ...
              <div class="py-2 py-sm-0 col-sm-8  ">
                ...
                <a href="{base_url()}/who_we_are" class="btn witBtn  float-right bigBtn  px-3">
                  READ MORE</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12 bg-light mt-5 p-5 colRadius">
            <div class="row ">
              ...
              <div class="py-2 py-sm-0 col-sm-8  ">
                ...
                <a href="{base_url()}/what_we_do" class="btn witBtn  float-right bigBtn  px-3">
                  READ MORE</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12 bg-light mt-5 p-5 colRadius">
            <div class="row ">
              ...
              <div class="py-5 py-sm-0 col-sm-8  ">
                ...
                <a href="{base_url()}/board_of_directors" class="btn witBtn float-right bigBtn  px-3">
                  READ MORE</a>
              </div>
            </div>
          </div>
