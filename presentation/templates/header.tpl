...
<head>
  ...
  <link type="text/css" href="{base_url()}/styles/home.css?v={jsversion()}" rel="stylesheet" />
          ...
          <div class="row no-gutters">
            ...
            <div class="col-sm-3">
              <div class="row no-gutters">
                ...
                <div class="col-sm-5"> <a href="{base_url()}/login" class="btn witBtn mt-4 joinWiT homeBtnStyle">Join
                    WiT</a></div>
          ...
          <div class="row">
            <div class="col-sm-12 py-5">
              ...
              <div class="text-white mt-4">
                ...
                <div class="aboutContainer">
                  <div class="py-1"><a href="{base_url()}/what_we_do" class="text-white fontStyle menubarOptions">WHAT
                      WE DO</a></div>
                  <div class="py-1"><a href="{base_url()}/who_we_are" class="text-white fontStyle menubarOptions">WHO
                      WE
                      ARE</a></div>
