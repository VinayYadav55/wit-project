...
<body>
      ...
      <div class="col-sm-4 col-12 py-2 text-center">
        ...
        <span class="dropdownMeHit px-3 py-3">
            ...
            <div class="dropdownMenuMenu">
              ...
              <a href="{base_url()}/login" class="dropdown-item loginStyle text-white">Login</a>
              <div class="dropdown-divider"></div>
              <a href="{base_url()}/employer" class="dropdown-item loginStyle text-white">Employer
                Login</a>
            </div>
          </span>
        {/if}
  ...
  <div class="mainContentSidebar mt-3">
      <div class="pastEvents m-4 pt-4">
        <h6 class="text-white"><a href="{base_url()}/wit_growth_summit_2019"
