...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{base_url()}/styles/witworkstream.css?v={jsversion()}" />
            ...
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row">
                ...
                <div class="py-2 py-sm-0 col-sm-8">
                  ...
                  <a href="{base_url()}/school_colleges" class="btn bigBtn float-right witBtn px-3">
                    READ MORE</a>
                </div>
              </div>
            </div>
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row ">
                ...
                <div class="py-2 py-sm-0 col-sm-8">
                  ...
                  <a href="{base_url()}/scholarship" class="btn bigBtn witBtn float-right px-3">
                    READ MORE</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row">
                ...
                <div class="py-2 py-sm-0 col-sm-8">
                  ...
                  <a href="{base_url()}/mentoring" class="btn bigBtn witBtn float-right px-3">
                    READ MORE</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row ">
                ...
                <div class="py-2 py-sm-0 col-sm-8">
                  ...
                  <a href="{base_url()}/secondcareers" class="btn bigBtn witBtn float-right px-3">
                    READ MORE</a>
                </div>
              </div>
            </div>
