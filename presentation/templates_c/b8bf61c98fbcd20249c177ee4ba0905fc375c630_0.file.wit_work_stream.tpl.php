<?php
/* Smarty version 3.1.33, created on 2019-09-12 15:37:27
  from '/home2/labiknmy/public_html/womenintech/presentation/templates/wit_work_stream.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d7a6637f04005_03243173',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b8bf61c98fbcd20249c177ee4ba0905fc375c630' => 
    array (
      0 => '/home2/labiknmy/public_html/womenintech/presentation/templates/wit_work_stream.tpl',
      1 => 1568277418,
      2 => 'file',
    ),
  ),
...
function content_5d7a6637f04005_03243173 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
/styles/witworkstream.css?v=<?php echo jsversion();?>
" />
  <title>WiT | WiT WORK STREAMS | WOMENINTECH | WiT</title>
</head>

<body>
  <?php $_smarty_tpl->_subTemplateRender('file:header.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
  <div class="witworkstreamTopStyle">
    <div class="bgimg">
      <div class="background-overlay"></div>
      <div class="container-fluid">
        <div class="container">
          <div class="row pb-5 ">
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row">
                <div class="col-sm-4">
                  <div class="img-div-fix">
                    <img src="images/final_images/original_schools_colleges_rbs_wit.png" alt="" class="img-fluid" />
                  </div>
                </div>
                <div class="py-2 py-sm-0 col-sm-8">
                  <h2 class="subHeading">SCHOOLS & COLLEGES</h2>
                  <hr />
                  <p class="witworkstreamTxtBound text-justify">
                    Technology is everywhere and it is imperative that young
                    girls are not just encouraged to aspire for careers in STEM,
                    but are also provided the right exposure and means to
                    achieve it. WiT is one such space for these girls.
                  </p>
                  <a href="<?php echo base_url();?>
/school_colleges" class="btn bigBtn float-right witBtn px-3">
                    READ MORE</a>
                </div>
              </div>
            </div>
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row ">
                <div class="col-sm-4">
                  <div class="img-div-fix">
                    <img src="images/final_images/scholarships_rbs_wit.png" alt="" class="img-fluid" />
                  </div>
                </div>
                <div class="py-2 py-sm-0 col-sm-8">
                  <h2 class="subHeading">SCHOLARSHIPS</h2>
                  <hr />
                  <p class="witworkstreamTxtBound text-justify">
                  ...
                  <a href="<?php echo base_url();?>
/scholarship" class="btn bigBtn witBtn float-right px-3">
                    READ MORE</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row">
                <div class="col-sm-4">
                  <div class="img-div-fix">
                    <img src="images/final_images/rbs_wit_mentoring_summary.jpg" alt=" " class="img-fluid" />
                  </div>
                </div>
                <div class="py-2 py-sm-0 col-sm-8">
                  <h2 class="subHeading">MENTORING</h2>
                  <hr />
                  <p class="witworkstreamTxtBound text-justify">
                    WiT aims to help women working in technology as well as women in other career paths looking to shift
                    to tech based roles. Also, while working in a male dominated industry, a support more accessible for
                    women working in STEM and looking for shifting to STEM careers.
                  </p>
                  <a href="<?php echo base_url();?>
/mentoring" class="btn bigBtn witBtn float-right px-3">
                    READ MORE</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row ">
                <div class="col-sm-4">
                  <div class="img-div-fix">
                    <img src="images/final_images/rbs_wit_second_career.jpg" alt="" class="img-fluid" />
                  </div>
                </div>
                <div class="py-2 py-sm-0 col-sm-8">
                  <h2 class="subHeading">SECOND CAREERS</h2>
                  <hr />
                  <p class="witworkstreamTxtBound text-justify">
                    There needs to be a simple way for women who’ve taken a
                    break from their careers to quickly reskill themselves in
                    the latest technology areas and rejoin the workforce. WiT
                    intends to focus on individual skills and competencies to
                    help such women forge a career by bridging the gap.
                  </p>
                  <a href="<?php echo base_url();?>
/secondcareers" class="btn bigBtn witBtn float-right px-3">
                    READ MORE</a>
                </div>
              </div>
            </div>
