<?php
/* Smarty version 3.1.33, created on 2019-11-08 11:25:42
  from 'C:\xampp\htdocs\womenintech\presentation\templates\user_edit_profile.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5dc542a6b0f2e4_83070245',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '73929a50c2e433a87a8c0b153c4f90a576a02e24' => 
    array (
      0 => 'C:\\xampp\\htdocs\\womenintech\\presentation\\templates\\user_edit_profile.tpl',
      1 => 1573208484,
      2 => 'file',
    ),
  ),
...
function content_5dc542a6b0f2e4_83070245 (Smarty_Internal_Template $_smarty_tpl) {
                ...
                <div class="form-group">
                  ...
                  <select class="job-location-cities preferCity" name="cities" multiple="multiple"
                    ...
                    <option value="Gurgaon" <?php if (in_array('Gurgaon',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Gurgaon </option>
                      ...
                      <option value="Bangalore" <?php if (in_array('Bangalore',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Bangalore
                      </option> <option value="Chennai" <?php if (in_array('Chennai',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Chennai
                      </option> <option value="Pune" <?php if (in_array('Pune',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Pune </option>
                      <option value="Kolkatta" <?php if (in_array('Kolkatta',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Kolkatta </option>
                      <option value="Mumbai" <?php if (in_array('Mumbai',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Mumbai </option> <option
                      value="Jaipur" <?php if (in_array('Jaipur',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Jaipur </option> <option
                      value="Indore" <?php if (in_array('Indore',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Indore </option> <option
                      value="Lucknow" <?php if (in_array('Lucknow',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Lucknow </option> <option
                      value="Goa" <?php if (in_array('Goa',$_smarty_tpl->tpl_vars['preferedCity']->value)) {?>selected<?php }?>>Goa </option> </select> </div> <div
                      class="form-group">
                      ...
                      <select class="employee-job-type preferJobType" name="jobtype" multiple="multiple"
                        ...
                        <option value="Full Time" <?php if (in_array('Full Time',$_smarty_tpl->tpl_vars['prefered_job_types']->value)) {?>selected<?php }?>>Full
                          Time</option> <option value="Part Time" <?php if (in_array('Part
                          Time',$_smarty_tpl->tpl_vars['prefered_job_types']->value)) {?>selected<?php }?>>Part Time</option> <option value="Remote Working" <?php if (in_array('Remote Working',$_smarty_tpl->tpl_vars['prefered_job_types']->value)) {?>selected<?php }?>>Remote Working</option> <option
                          value="Consultant" <?php if (in_array('Consultant',$_smarty_tpl->tpl_vars['prefered_job_types']->value)) {?>selected<?php }?>>Consultant
                          </option> <option value="Volunteer" <?php if (in_array('Volunteer',$_smarty_tpl->tpl_vars['prefered_job_types']->value)) {?>selected<?php }?>>Volunteer </option> <option
                          value="Paid Internship" <?php if (in_array('Paid Internship',$_smarty_tpl->tpl_vars['prefered_job_types']->value)) {?>selected<?php }?>>Paid
                          Internship</option> <option value="Unpaid Internship" <?php if (in_array('Unpaid
                          Internship',$_smarty_tpl->tpl_vars['prefered_job_types']->value)) {?>selected<?php }?>>Unpaid Internship</option> </select> </div>
                          <div class="form-group">
                          ...
                          <select class="employee-functional-area employeefunctionalArea" name="functionalarea"
                            ...
                            <option value="Art Director / Graphic / Web Designer" <?php if (in_array('Art Director / Graphic /
                              Web Designer',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Art Director / Graphic / Web
                              Designer</option> <option value="Audit" <?php if (in_array('Audit',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Audit </option> <option
                              value="Accounting / finance" <?php if (in_array('Accounting /
                              finance',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Accounting / finance</option> <option
                              value="Computer Operator / Data Entry" <?php if (in_array('Computer Operator / Data
                              Entry',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Computer Operator / Data Entry</option> <option
                              value="Database Administrator / Data Warehouse" <?php if (in_array('Database / Administrator /
                              Data Warehouse',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Database Administrator / Data
                              Warehouse</option> <option value="Digital Marketing / SEM / SEO" <?php if (in_array('Digital
                              Marketing / SEM / SEO',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Digital Marketing / SEM /
                              SEO</option> <option value="HR" <?php if (in_array('HR',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>HR
                              </option> <option value="Management" <?php if (in_array('Management',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Management </option> <option
                              value="Network Administrator" <?php if (in_array('Network
                              Administrator',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Network Administrator</option> <option
                              value="Operations" <?php if (in_array('Operations',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Operations
                              </option> <option value="Project Management" <?php if (in_array('Project
                              Management',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Project Management</option> <option
                              value="WebDesigner / UI / UX Designer" <?php if (in_array('WebDesigner / UI / UX
                              Designer',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>WebDesigner / UI / UX Designer</ option>
                            <option value="Software Testing" <?php if (in_array('Software
                              Testing',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Software Testing</option> <option
                              value="Sales / Marketing" <?php if (in_array('Sales /
                              Marketing',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Sales / Marketing </option> <option
                              value="Software Development" <?php if (in_array('Software
                              Development',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Software Development</option> <option
                              value="Others" <?php if (in_array('Others',$_smarty_tpl->tpl_vars['functional_area']->value)) {?>selected<?php }?>>Others </option>
                              </select> </div> <?php $_smarty_tpl->_assignInScope('industry_type', $_smarty_tpl->tpl_vars['candidateDetail']->value['industry_type_array']);?>
                              <div class="form-group">
                              ...
                              <select class="employee-industry-type employeeIndustryType" name="functionalarea"
                                multiple="multiple" style="width: 100% !important; border:none;">
                                <option value="Accounting / Finance" <?php if (in_array('Accounting /
                                  Finance',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>Accounting / Finance</option> <option
                                  value="Banking / Financial Services" <?php if (in_array('Banking / Financial
                                  Services',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>Banking / Financial Services</option> <option
                                  value="IT- Hardware and Networking" <?php if (in_array('IT- Hardware and
                                  Networking',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>IT- Hardware and Networking</option> <option
                                  value="Medical / Healthcare" <?php if (in_array('Medical /
                                  Healthcare',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>Medical / Healthcare</option> <option
                                  value="Telecom / ISP" <?php if (in_array('Telecom /
                                  ISP',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>Telecom / ISP</option> <option
                                  value="Recruitment / Staffing" <?php if (in_array('Recruitment /
                                  Staffing',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>Recruitment / Staffing</option> <option
                                  value="KPO / Research / Analytics" <?php if (in_array('KPO / Research /
                                  Analytics',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>KPO / Research / Analytics</option> <option
                                  value="Internet / E-commerce" <?php if (in_array('Internet /
                                  E-commerce',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>Internet / E-commerce</option> <option
                                  value="IT-Software / Software Services" <?php if (in_array('IT-Software / Software
                                  Services',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>IT-Software / Software Services</option>
                                  <option value="Education / Teaching / Training" <?php if (in_array('Education / Teaching /
                                  Training',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>Education / Teaching / Training</option>
                                  <option value="Others" <?php if (in_array('Others',$_smarty_tpl->tpl_vars['industry_type']->value)) {?>selected<?php }?>>Others
                                  ...
                                  <div class="form-group">
                                    <select class="select-experience employeeExperience" name="state"
                                      style="width: 100% !important;"><?php $_smarty_tpl->_assignInScope('experience', $_smarty_tpl->tpl_vars['candidateDetail']->value['experience']);?>
                                      <option disabled="disabled" selected="true">Select</option>
                                      <option value="0-3" <?php if ('0-3' == $_smarty_tpl->tpl_vars['experience']->value) {?>selected<?php }?>>0-3 Year</option> <option
                                        value="3-6" <?php if ('3-6' == $_smarty_tpl->tpl_vars['experience']->value) {?>selected<?php }?>>3-6 Year</option> <option
                                        value="6-10" <?php if ('6-10' == $_smarty_tpl->tpl_vars['experience']->value) {?>selected<?php }?>>6-10 Year</option> <option
                                        value="10+" <?php if ('10+' == $_smarty_tpl->tpl_vars['experience']->value) {?>selected<?php }?>>10+ Year</option> </select>
                                              ...
                                              <details class="mt-3">
                                                ...
                                                <div class="form-group employeehighschoolrecord">
                                                  ...
                                                  <input type="text" class="form-control employeehighschoolboardname"
                                                    placeholder="C.B.S.E. etc" value="<?php echo $_smarty_tpl->tpl_vars['class_10_details']->value['BoardName'];?>
" />
                                                </div>
                                                <div class="form-group employeehighschoolrecord">
                                                  <label for="">School Name</label>
                                                  <input type="text" class="form-control employeehighschoolschoolname"
                                                    placeholder="DPS etc" value="<?php echo $_smarty_tpl->tpl_vars['class_10_details']->value['schoolName'];?>
" />
                                                </div>
                                                <div class="form-group employeehighschoolrecord">
                                                  <label for="">Year of Complition</label>
                                                  <input type="text" class="form-control employeehighschoolpassingyear"
                                                    placeholder="2002 etc" value="<?php echo $_smarty_tpl->tpl_vars['class_10_details']->value['passingYear'];?>
" />
                                                </div>
                                                <div class="form-group employeehighschoolrecord">
                                              ...
                                              <details class="mt-3">
                                                ...
                                                <div class="form-group employeehighersecondaryrecord">
                                                  ...
                                                  <input type="text"
                                                    ...
                                                    placeholder="C.B.S.E etc" value="<?php echo $_smarty_tpl->tpl_vars['class_12_details']->value['BoardName'];?>
" />
                                                </div>
                                                <div class="form-group employeehighersecondaryrecord">
                                                  <label for="">School Name</label>
                                                  <input type="text"
                                                    ...
                                                    placeholder="DPS etc" value="<?php echo $_smarty_tpl->tpl_vars['class_12_details']->value['schoolName'];?>
" />
                                                </div>
                                                <div class="form-group employeehighersecondaryrecord">
                                                  <label for="">Year of Complition</label>
                                                  <input type="text"
                                                    ...
                                                    placeholder="2002 etc" value="<?php echo $_smarty_tpl->tpl_vars['class_12_details']->value['passingYear'];?>
" />
                                                </div>
                                                <div class="form-group employeehighersecondaryrecord">
                                                  <label for="">Percentage/ Marks</label>
                                              ...
                                              <details class="mt-3">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control employeegraduationinstitute"
                                                    placeholder="IIT Delhi etc" value="<?php echo $_smarty_tpl->tpl_vars['grd_details']->value['collegeName'];?>
" />
                                                </div>
                                                <div class="form-group">
                                                  <label for="">Course</label>
                                                  <input type="text" class="form-control employeegraduationcourse"
                                                    placeholder="MBA etc" value="<?php echo $_smarty_tpl->tpl_vars['grd_details']->value['course'];?>
" />
                                                </div>
                                                <div class="form-group">
                                                  ...
                                                  <input type="text"
                                                    ...
                                                    placeholder="Finance etc" value="<?php echo $_smarty_tpl->tpl_vars['grd_details']->value['Specilization'];?>
" />
                                                </div>
                                                <div class="form-group">
                                                  <label for="">Year of Complition</label>
                                                  <input type="text" class="form-control employeegraduationpassingyear"
                                                    placeholder="2011 etc" value="<?php echo $_smarty_tpl->tpl_vars['grd_details']->value['Year_of_Complition'];?>
" />
                                                </div>
                                                <div class="form-group">
                                              ...
                                              <details class="mt-3">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <input type="text"
                                                    ...
                                                    placeholder="IIT Delhi etc" value="<?php echo $_smarty_tpl->tpl_vars['pg_details']->value['collegeName'];?>
" />
                                                </div>
                                                <div class="form-group">
                                                  <label for="">Course</label>
                                                  <input type="text" class="form-control employeepostgraduationcourse"
                                                    placeholder="MBA etc" value="<?php echo $_smarty_tpl->tpl_vars['pg_details']->value['course'];?>
" />
                                                </div>
                                                <div class="form-group">
                                                  <label for="">Specilization</label>
                                                  <input type="text"
                                                    ...
                                                    placeholder="Finance etc" value="<?php echo $_smarty_tpl->tpl_vars['pg_details']->value['Specilization'];?>
" />
                                                </div>
                                                <div class="form-group">
                                                  <label for="">Year of Complition</label>
                                                  <input type="text"
                                                    ...
                                                    placeholder="2011 etc" value="<?php echo $_smarty_tpl->tpl_vars['pg_details']->value['Year_of_Complition'];?>
" />
                                                </div>
                                                <div class="form-group">
                                                  <label for="">Percentage / CGPA/ GPA</label>
...
" />
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control employeeothercourse"
                                                    placeholder="Phd etc" value="<?php echo $_smarty_tpl->tpl_vars['other_class_details']->value['course'];?>
" />
                                                </div>
                                                <div class="form-group">
                                                  <label for="">Specilization</label>
                                            ...
                                            <div class="card-body">
                                              <div class="form-group">
                                                <select class="employee-skills employeeskills" name="skills"
                                                  ...
                                                  <option value="HTML" <?php if (in_array('HTML',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>HTML </option> <option value="CSS" <?php if (in_array('CSS',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>CSS </option> <option
                                                    value="JavaScript" <?php if (in_array('JavaScript',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>JavaScript </option> <option value="Java"
                                                    <?php if (in_array('Java',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>Java </option> <option
                                                    value="NodeJs" <?php if (in_array('NodeJs',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>NodeJs </option> <option value="Angular2+"
                                                    <?php if (in_array('Angular2',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>Angular2+
                                                    </option> <option value="AngularJs" <?php if (in_array('AngularJs',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>AngularJs </option> <option value="JQuery"
                                                    <?php if (in_array('JQuery',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>JQuery </option>
                                                    <option value="Python" <?php if (in_array('Python',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>Python </option> <option value="BigData"
                                                    <?php if (in_array('BigData',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>Big Data</option>
                                                    <option value="DataScience" <?php if (in_array('DataScience',$_smarty_tpl->tpl_vars['skillset']->value)) {?>selected<?php }?>>Data Science</option> </select> </div>
...
" />
                                                        ...
                                                        <details class="mt-3">
                                                          <summary class="bg-light"
                                                            style="border: 1px solid #e6e4e4; outline: none; box-shadow: none;">
                                                            Project 2</summary><?php $_smarty_tpl->_assignInScope('project_2_details', $_smarty_tpl->tpl_vars['candidateDetail']->value['projectDetails'][1]);?>
                                                          <div class="form-group">
                                                            <label for="">Project Title</label>
                                                            <input type="text"
                                                      ...
                                                      <div class="form-group col-6">
                                                        ...
                                                        <select class="form-control employeemaritalstatus" id="sel1">
                                                          ...
                                                          <option value="Single/Unmarried"
                                                            <?php if ('Single/Unmarried' == $_smarty_tpl->tpl_vars['candidateDetail']->value['martial_status']) {?>selected<?php }?>>Single/Unmarried
                                                            </option> <option value="Married"
                                                            <?php if ('Married' == $_smarty_tpl->tpl_vars['candidateDetail']->value['martial_status']) {?>selected<?php }?>>Married
                                                            ...
                                                            <textarea class="form-control employeepermanentaddress"
                                                              rows="2"
                                                              id="comment"><?php echo $_smarty_tpl->tpl_vars['candidateDetail']->value['permanent_address'];?>
</textarea>
                                                      </div>
                                                      <div class="form-row">
                                                        <div class="form-group col-6">
 ...
 />
                                                ...
                                                <div class="py-2 px-4 bg-light" style="border: 1px solid #dcdcdc;">
                                                  ...
                                                  <input type="radio" class="currentJobDiv" name="workingcurrently"
                                                    ...
                                                    <?php if ('Yes' == $_smarty_tpl->tpl_vars['candidateDetail']->value['currently_working_status']) {?>checked<?php }?>} />&nbsp;
                                                  &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
                                                  &nbsp; &nbsp;
                                                  <label for="">No</label>
...
" />
                                                          ...
                                                          <div class="form-group">
                                                            ...
                                                            <textarea class="form-control employeecurrentjobdescription"
                                                              rows="3"
                                                              id="comment"><?php echo $_smarty_tpl->tpl_vars['candidateDetail']->value['current_job_descripton'];?>
</textarea>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    ...
                                                    <div id="collapseFive" class="collapse"
                                                      ...
                                                      <div class="card-body employmentDetailsDiv">
                                                        ...
                                                        <details class="mt-3">
                                                          <summary class="bg-light"
                                                            style="border: 1px solid #e6e4e4; outline: none; box-shadow: none;">
                                                            job1</summary><?php $_smarty_tpl->_assignInScope('job_1_details', $_smarty_tpl->tpl_vars['candidateDetail']->value['previousJobDetails'][0]);?>
...
" />
                                                            ...
                                                            <div class="form-group">
                                                              ...
                                                              <textarea
                                                                ...
                                                                rows="2"
                                                                id="comment"> <?php echo $_smarty_tpl->tpl_vars['job_1_details']->value['description'];?>
</textarea>
                                                            </div>
                                                          </div>
                                                        </details>
                                                        ...
                                                        <details class="mt-3">
                                                          <summary class="bg-light"
                                                            style="border: 1px solid #e6e4e4; outline: none; box-shadow: none;">
                                                            job2</summary><?php $_smarty_tpl->_assignInScope('job_2_details', $_smarty_tpl->tpl_vars['candidateDetail']->value['previousJobDetails'][1]);?>
...
" />
                                                            ...
                                                            <div class="form-group">
                                                              ...
                                                              <textarea
                                                                ...
                                                                rows="2"
                                                                id="comment"> <?php echo $_smarty_tpl->tpl_vars['job_2_details']->value['description'];?>
</textarea>
                                                            </div>
                                                          </div>
                                                        </details>
                                                        ...
                                                        <details class="mt-3">
                                                          <summary class="bg-light"
                                                            style="border: 1px solid #e6e4e4; outline: none; box-shadow: none;">
                                                            job3</summary><?php $_smarty_tpl->_assignInScope('job_3_details', $_smarty_tpl->tpl_vars['candidateDetail']->value['previousJobDetails'][2]);?>
...
" />
                                                            ...
                                                            <div class="form-group">
                                                              ...
                                                              <textarea
                                                                ...
                                                                rows="2"
                                                                id="comment"><?php echo $_smarty_tpl->tpl_vars['job_3_details']->value['description'];?>
</textarea>
                                                            </div>
                                                          </div>
                                                        </details>
