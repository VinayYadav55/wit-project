<?php
/* Smarty version 3.1.33, created on 2019-11-06 18:33:44
  from 'C:\xampp\htdocs\womenintech\presentation\templates\wit_view_company_full_detail.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5dc303f811d5f6_03541958',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f1592971d1a3232cad063a328f6c1f2a19cdbc58' => 
    array (
      0 => 'C:\\xampp\\htdocs\\womenintech\\presentation\\templates\\wit_view_company_full_detail.tpl',
      1 => 1571827891,
      2 => 'file',
    ),
  ),
...
function content_5dc303f811d5f6_03541958 (Smarty_Internal_Template $_smarty_tpl) {
...
/images/wit-favicon.ico" type="image/x-icon">
  <title>WiT | LIST OF JOBS POSTED BY COMPANY |COMPANY FULL DETAILS</title>
...
" rel="stylesheet" />
  <link href="<?php echo base_url();?>
/styles/wit_dashboard.css?v=<?php echo jsversion();?>
" rel="stylesheet" />
          ...
          <div class="col-sm-12 bg-white borderStyle">
            <div class="row">
              <div class="col-sm-6 px-4 bg-white py-4 my-2" style="border-right:1px solid gray;">
                ...
                <p class="paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['company']->value['company_description'];?>
</p>
                ...
                <p class="paragraphStyles text-capitalize"><?php echo $_smarty_tpl->tpl_vars['company']->value['state'];?>
</p>
                <h6 class="headingStyles pt-2">City</h6>
                <p class="paragraphStyles text-capitalize"><?php echo $_smarty_tpl->tpl_vars['company']->value['city'];?>
</p>
                <h6 class="headingStyles pt-2">Office Address</h6>
                <p class="paragraphStyles text-capitalize"><?php echo $_smarty_tpl->tpl_vars['company']->value['office_address'];?>
</p>
                <h6 class="headingStyles pt-2">Pin Code / Zip</h6>
                <p class="paragraphStyles"> <?php echo $_smarty_tpl->tpl_vars['company']->value['pin_code'];?>
</p>
              ...
              <div class="col-sm-6 px-4 py-4 bg-white my-2">
                ...
                <p class="text-capitalize paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['company']->value['designation'];?>
</p>
                ...
                <p class="paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['company']->value['alternate_email_address'];?>
</p>
...
"><?php echo $_smarty_tpl->tpl_vars['job']->value['job_title'];?>
                    ...
                    <td class=<?php if ($_smarty_tpl->tpl_vars['job']->value['active_status'] === 'Active') {?>text-success<?php } else { ?>text-dark<?php }?>><?php echo $_smarty_tpl->tpl_vars['job']->value['active_status'];?>
