<?php
/* Smarty version 3.1.33, created on 2019-08-31 11:45:37
  from '/home2/labiknmy/public_html/vipananwebtest/presentation/templates/past_specific_event.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d6a5de1e72038_50320474',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f496c8adb65fcf9ceddd305e403a6456ca35337b' => 
    array (
      0 => '/home2/labiknmy/public_html/vipananwebtest/presentation/templates/past_specific_event.tpl',
      1 => 1567157348,
      2 => 'file',
    ),
  ),
...
function content_5d6a5de1e72038_50320474 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
                  ...
                  <div class="img-div-fix">
                    <a href="" data-toggle="modal" data-target="#myModal">
                      <img
                        ...
                        src="images/tamilnadu-wit-rbs-event-group.jpg"
                        alt="Card image"
                    /></a>
                  </div>
                </div>
            ...
            <div class="row my-5">
              ...
              <div class="col-sm-3">
                <div class="speakerImgDiv">
                  <div class="imageContainerSpeaker">
                    <img
                      src="images/gautami_tadimalla.jpg"
                      class="main-image-speaker"
                      alt=""
                    />
                  </div>
            ...
            <div class="row my-5">
              <div class="col-sm-3">
                <div class="speakerImgDiv">
                  <div class="imageContainerSpeaker">
                    <img
                      src="images/mk_surappa_anna_university.jpg"
                      class="main-image-speaker"
                      alt=""
                    />
                  </div>
              ...
              <div class="col-sm-3">
                <div class="speakerImgDiv">
                  <div class="imageContainerSpeaker">
                    <img
                      src="images/DR.MARIAZEENA-JOHNSON.jpg"
                      class="main-image-speaker"
                      alt=""
                    />
                  </div>
                  ...
                  <div class="row">
                    ...
                    >
                      ...
                      <div class="img-thumbnail1 img-thumb">
                        <img
                          class=" gallery"
                          src="images/tamilnadu-wit-rbs-event-anuranjita.jpg"
                          alt=""
                        />
                      </div>
                      <div class="img-thumbnail1 img-thumb">
                      ...
                      <div class="img-thumbnail1 img-thumb">
                        <img
                          class=" gallery"
                          src="images/tamilnadu-wit-rbs-event.jpg"
                          alt=""
                        />
                      </div>
                      <div class="img-thumbnail1 img-thumb">
                        <img
                          class=" gallery "
                          src="images/tamilnadu-wit-rbs-event-awards.jpg"
                          alt=""
                        />
                      </div>
                      <div class="img-thumbnail1 img-thumb">
                      ...
                      <div class="img-thumbnail1 img-thumb">
                        <img
                          class=" gallery"
                          src="images/tamilnadu-wit-rbs-event-mainhead.jpg"
                          alt=""
                        />
                      </div>
                      <div class="img-thumbnail1 img-thumb">
                        <img
                          class=" gallery"
                          src="images/tamilnadu-wit-rbs-event-meating.jpg"
                          alt=""
                        />
                      </div>
                      <div class="img-thumbnail1 img-thumb">
