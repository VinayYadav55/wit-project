...
/images/witlogo-logo-dashboard.png">
...
" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>
/styles/newsinsites.css?v=<?php echo jsversion();?>
" />
  ...
  <div id="sidebar" class="sidenav sidenav-fixed expand-lg">
    <div class="mt-4 h-100 ">
     <div class="listPastEvents m-4 pt-4">
        <h4 class="text-center neon" data-text="Events & News">Events & News</h4>
      </div>
      <hr class="w-25 mt-5 bg-success">
  <div class="mainContentSidebar mt-3">
      <div class="pastEvents m-4 pt-4">
        <h6 class="text-white"><a href="<?php echo base_url();?>
/wit_growth_summit_2019"
            class="text-white textStylingEvents"><small>WomenInTech(WiT)
            Growth Summit, hosted by WomenInTech(WiT)</small></a></h6>
        <div class="pastNewsCal"><i class="far fa-calendar-alt"></i> 16th Oct , 2019</div>
      </div>

      <div class="pastEvents m-4 pt-4">
        <h6 class="text-success"><a href="<?php echo base_url();?>
/past_specific_event"
            class="text-white textStylingEvents"><small>Tamilnadu Chapter
            Launch,hosted by Amazon</small></a></h6>
...
/past_specific_event1"
            class="text-white textStylingEvents"><small>Pune Chapter
            Launch, hosted by Mastercard</small></a></h6>
...
/past_specific_event2"
            class="text-white textStylingEvents"><small>Bengaluru Chapter
            Launch,
            hosted by IBM</small></a></h6>
...
/past_specific_event3"
            class="text-white textStylingEvents"><small>Delhi
            NCR Chapter Launch,
            hosted by RBS</small><br>
    ...
    <a href="javascript:;" class="sidebar-toggler js-sidebar-toggler navbar-icon closerSidebarBtn"
        data-target="#sidebar">
        <span class="closerSidebarBtn text-white  bg-secondary py-2 px-3"><small> <i class="fas fa-angle-double-right animated slideOutRight infinite text-white "></i> </small></span>
      </a>
    </div>
  </div>
...
/did_you_know">DID YOU KNOW</a>
              ...
              <div class="col-sm-3  text-center blockForBtn">
                <a href="<?php echo base_url();?>
/job_portal" class="btn witBtn mt-4 homeBtnStyle">Search
                  Jobs</a> &nbsp;
                <a href="<?php echo base_url();?>
/login" class="btn witBtn mt-4 homeBtnStyle">Join WiT</a>
              </div>
            </div>
          </div>
        </div>
...
/images/techvideo_rbswit.mp4" type="video/mp4">
          ...
          <a href="<?php echo base_url();?>
/login" class="btn btn-primary px-4 py-2 ml-5  joinbtn d-block d-sm-none">JOIN WiT</a>
          <a href="javascript:;" class="sidebar-toggler js-sidebar-toggler navbar-icon sociaLogo sidebarBtn"
            data-target="#sidebar">
            <span class="openerSidebarBtn text-white txtStyling bg-secondary py-2"><small>OPEN  <i class="fas fa-external-link-alt fa-spin"></i></small> </span>
          </a>
                ...
                <div class="col-sm-4">
                  <div class="speakerImgDivHome">
                    <div class="imageContainerSpeakerHome">
                      <img src="<?php echo base_url();?>
/images/anuranjita_kumar.jpg" class="main-image-speakerHome rounded-circle"
                        alt="" />
                    </div>
                  </div>
                  <div class="details">
                ...
                <div class="col-sm-4">
                  <div class="speakerImgDivHome">
                    <div class="imageContainerSpeakerHome">
                      <img src="<?php echo base_url();?>
/images/founder1.jpeg" class="main-image-speakerHome rounded-circle"
                        alt="" />
                    </div>
                  </div>
                  <div class="details">
              ...
              <div class="row my-0  my-sm-5">
                <div class="col-sm-3">
                  <div class="speakerImgDivHome">
                    <div class="imageContainerSpeakerHome">
                      <img src="<?php echo base_url();?>
/images/rajesh_jogi_head_risk_hub_india.jpg"
                ...
                <div class="col-sm-3">
                  <div class="speakerImgDivHome">
                    <div class="imageContainerSpeakerHome">
                      <img src="<?php echo base_url();?>
/images/neeraj_goyal.jpg" class="main-image-speakerHome rounded-circle"
                        alt="" />
                    </div>
                  </div>
                  <div class="details">
                ...
                <div class="col-sm-3">
                  <div class="speakerImgDivHome">
                    <div class="imageContainerSpeakerHome">
                      <img src="<?php echo base_url();?>
/images/chaitnya_srinivas.png" class="main-image-speakerHome rounded-circle"
                        alt="" />
                    </div>
                  </div>
                  <div class="details">
                ...
                <div class="col-sm-3">
                  <div class="speakerImgDivHome">
                    <div class="imageContainerSpeakerHome">
                      <img src="<?php echo base_url();?>
/images/sukanya_mishra_mastercard.png"
                        class="main-image-speakerHome rounded-circle" alt="" />
                    </div>
                  </div>
                  <div class="details">
                ...
                <div class="col-sm-4">
                  <div class="speakerImgDivHome">
                    <div class="imageContainerSpeakerHome">
                      <img src="<?php echo base_url();?>
/images/Manikandan Thangarathnam.jpeg"
                        class="main-image-speakerHome rounded-circle" alt="" />
                    </div>
                  </div>
                  <div class="details">
...
/js/home.js?v=<?php echo jsversion();?>
"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
