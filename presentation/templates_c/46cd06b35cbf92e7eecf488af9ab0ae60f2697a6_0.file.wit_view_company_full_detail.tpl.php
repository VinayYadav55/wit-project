<?php
/* Smarty version 3.1.33, created on 2019-08-22 07:44:03
  from 'C:\xampp\htdocs\djdfbf\sanjeev\presentation\templates\wit_view_company_full_detail.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d5e2ba3334ac4_52911391',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '46cd06b35cbf92e7eecf488af9ab0ae60f2697a6' => 
    array (
      0 => 'C:\\xampp\\htdocs\\djdfbf\\sanjeev\\presentation\\templates\\wit_view_company_full_detail.tpl',
      1 => 1566452620,
      2 => 'file',
    ),
  ),
...
function content_5d5e2ba3334ac4_52911391 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  <header class="navbar navbar-expand-lg navbar-dark fixed-top navbar-scrolling header scrolled">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="nav navbar-nav navbar-toolbar ml-auto">
        <li class="logout text-white border border-dark"> Log Out</li>
      </ul>
    </div>
  </header>
...
/dashboard">Dashboard</a>
  ...
  <div class="docs-content-wrapper border border-dark">
    <div class="container">
      <div class="row">
        <div class="col-sm-12 py-5" style="position: sticky; top:20px; z-index:1;">
          <h4 class="bg-light">Full Details of <?php echo $_smarty_tpl->tpl_vars['company']->value['company_name'];?>
</h4>
        </div>
        <div class="col-sm-6">
          <h4>Compnay Name</h4>
