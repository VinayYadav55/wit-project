<?php
/* Smarty version 3.1.33, created on 2019-09-12 08:47:22
  from '/home2/labiknmy/public_html/womenintech/presentation/templates/about.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d7a061a4e23b3_70821419',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '52108e7ad80fd53950a0acb662a6c1252c786ea1' => 
    array (
      0 => '/home2/labiknmy/public_html/womenintech/presentation/templates/about.tpl',
      1 => 1568272961,
      2 => 'file',
    ),
  ),
...
function content_5d7a061a4e23b3_70821419 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
?>
  ...
  <div class="bgimg ">
    ...
    <div class="container-fluid  pt-0 pt-sm-5">
      <div class="container py-5 mt-5">
        <div class="row my-5">
          <div class="col-sm-12 bg-light  p-5 colRadius">
            <div class="row ">
              <div class="col-sm-4">
                <img src="images/who_we_are_rbs_wit.jpg" alt="" style="height: auto; width:100%;" />
              </div>
...
/who_we_are" class="btn witBtn  float-right bigBtn  px-3">
                  READ MORE</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12 bg-light mt-5 p-5 colRadius">
            <div class="row ">
              <div class="col-sm-4">
                <img src="images/final_images/what_we_dp_rbs_wit_original.png" alt=""
              ...
              <div class="py-2 py-sm-0 col-sm-8  ">
                ...
                <a href="<?php echo base_url();?>
/what_we_do" class="btn witBtn  float-right bigBtn  px-3">
                  READ MORE</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12 bg-light mt-5 p-5 colRadius">
            <div class="row ">
              <div class="col-sm-4">
                <img src="images/final_images/board_of_director_rbs_wit.png" alt="" style="height: auto; width:100%;" />
              </div>
              <div class="py-5 py-sm-0 col-sm-8  ">
                <h2 class="subHeading pt-0 pt-xs-5">MEMBERS</h2>
                <hr />
                <p class="aboutTxtBound">
                  WomenInTech addresses the need to work collectively as an industry to ensure that workplaces not
                  only promote more women to take up education and careers in technology, but also create a conducive
                  environment for working women to aspire for senior level roles.
                </p>
                <a href="<?php echo base_url();?>
/board_of_directors" class="btn witBtn float-right bigBtn  px-3">
                  READ MORE</a>
              </div>
            </div>
          </div>
  ...
  <div class="mt-5">
    <div class="container-fluid bg-white p-3 p-sm-5 didYouKnowContainer">
      <div class="container">
        <div class="row">
