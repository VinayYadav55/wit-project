<?php
/* Smarty version 3.1.33, created on 2019-07-22 14:17:04
  from 'C:\xampp\htdocs\rbs\presentation\templates\who_we_are.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d35c5604c4e32_26343847',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '39dd9f685ff91a331498dce9253c6611cfbe7bb2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\rbs\\presentation\\templates\\who_we_are.tpl',
      1 => 1563804998,
      2 => 'file',
    ),
  ),
...
function content_5d35c5604c4e32_26343847 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
      ...
      <div class="container">
        <div class="row p-4">
          <div class="col-sm-6 justify-content-center text-center">
            <h3 class=" text-center subHeading ">ABOUT US</h3>
            <hr />
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 py-5">
            ...
            <hr />
            <p class="text-center ourVisionText">
      ...
      <div class="container">
        <div class="row mt-5 pt-5">
          ...
          <div class="col-sm-8 justify-content-center text-center">
            ...
            <a href="?board_of_directors=true" class="btn witBtn px-3"
              >READ MORE</a
            >
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 py-5">
                ...
                <div class="col-sm-4">
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="column">
                        <div class="col-md-12">
                          <img src="images/grow2.png" class="growDevelop" />
                        </div>
                        <div class="col-md-12  py-5">
                          <h4 class=" display-3 whowearetext">
                            <strong>Grow</strong>
                          </h4>
                        </div>
                      </div>
                ...
                <div class="col-sm-4">
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="column">
                        <div class="col-md-12">
                          <img src="images/develop.png" class="growDevelop" />
                        </div>
                        <div class="col-md-12  py-5">
                          <h4 class=" display-3 whowearetext">
                    ...
                    <div class="col-sm-10">
                      <div class="column">
                        <div class="col-md-12" style="margin: auto;">
                          <img src="images/connect.png" class="growDevelop" />
                        </div>
                        <div class="col-md-12  py-5">
                          <h4 class=" display-3 whowearetext">
            ...
            <!--
            <h4 class="text-center display-3 whowearetext">
              <strong>Grow. Develop. Connect.</strong>
            </h4> -->

            <hr />
            <h4 class="Heading text-center py-4"></h4>
            <p class="text-center">
              WomenInTech addresses the need to work collectively as an industry
              to ensure that workplaces not only promote more women to take up
              ...
              <strong
                >Anuranjita Kumar <br />
                (HR Head of RBS International Hubs and Chairperson WiT)</strong
              >
            </p>
          </div>
        </div>
