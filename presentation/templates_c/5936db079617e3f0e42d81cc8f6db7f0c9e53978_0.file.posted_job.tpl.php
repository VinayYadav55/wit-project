<?php
/* Smarty version 3.1.33, created on 2019-09-13 08:46:47
  from '/home2/labiknmy/public_html/womenintech/presentation/templates/posted_job.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d7b5777c16210_66374286',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5936db079617e3f0e42d81cc8f6db7f0c9e53978' => 
    array (
      0 => '/home2/labiknmy/public_html/womenintech/presentation/templates/posted_job.tpl',
      1 => 1568275755,
      2 => 'file',
    ),
  ),
...
function content_5d7b5777c16210_66374286 (Smarty_Internal_Template $_smarty_tpl) {
                ...
                <div class="container">
                  <div class="row my-4" style="border:1px solid #8080804d;">
                    <div class="col-sm-6 bg-white p-4" style="border-right:1px solid #8080804d;">
                      ...
                      <p class="py-1 text-capitalize paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['job_title'];?>
</p>
                      <h5 class="py-1 headingStyles">Qualification</h5>
                      <p class="py-1 paragraphStyles "><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['qualifications'];?>
</p>
                      <h5 class="py-1 headingStyles">Work Experience</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['work_experience'];?>
 Year</p>
                      <h5 class="py-1 headingStyles">Skills</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['required_skills'];?>
</p>
                      <h5 class="py-1 headingStyles">Job Type</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['job_type'];?>
</p>
                      <h5 class="py-1 headingStyles">Job Location</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['job_location'];?>
</p>
                       <h5 class="py-1 headingStyles">Functional Area</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['job_functional_area'];?>
</p>
                      <h5 class="py-1 headingStyles">Industry Type</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['job_industry_type'];?>
</p>
                      <h5 class="py-1 headingStyles">number of opening</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['total_openings'];?>
</p>
                      <h5 class="py-1 headingStyles">End Date</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['deadline_date'];?>
</p>
                      <h5 class="py-1 headingStyles">Salary</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['salary_provide'];?>
</p>
                      </div>
                      <div class="col-sm-6 bg-white  p-4">
                     <h5 class="py-1 headingStyles">Job Description</h5>
                      <p class="py-1 paragraphStyles"><?php echo $_smarty_tpl->tpl_vars['jobDetail']->value['job_description'];?>
</p>
                    </div>
                  </div>
                </div>
