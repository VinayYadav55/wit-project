<?php
/* Smarty version 3.1.33, created on 2019-08-29 11:20:03
  from 'C:\xampp\htdocs\vipananwebtest\presentation\templates\wit_work_stream.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d6798c3e3c110_08737778',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bdde61738c8338e3f0da942ea3fe835884b644e3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vipananwebtest\\presentation\\templates\\wit_work_stream.tpl',
      1 => 1567069580,
      2 => 'file',
    ),
  ),
...
function content_5d6798c3e3c110_08737778 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
            ...
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row">
                ...
                <div class="py-2 py-sm-0 col-sm-8">
                  <h2 class="subHeading">School & Colleges</h2>
                  <hr />
...
/school_colleges"
                    class="btn bigBtn float-right witBtn px-3"
                  >
                    READ MORE</a
                  >
                </div>
              ...
              <div class="row ">
                ...
                <div class="py-2 py-sm-0 col-sm-8">
                  ...
                  <a
                    href="<?php echo base_url();?>
/scholarship"
                    class="btn bigBtn witBtn float-right px-3"
                  >
                    READ MORE</a
                  >
                </div>
              ...
              <div class="row">
                ...
                <div class="py-2 py-sm-0 col-sm-8">
                  ...
                  <p class="witworkstreamTxtBound text-justify">
                    ...
                    women in other career paths looking to shift to tech based
                    roles. Also, while working in a male dominated industry, a
                    support system of peers and mentors becomes essential and
                    the community at WiT makes this support more accessible.
                  </p>
                  <a
                    href="<?php echo base_url();?>
/mentoring"
            ...
            <div class="col-sm-12 bg-white mt-5 p-5 witworkstreamcolRadius">
              <div class="row ">
                ...
                <div class="py-2 py-sm-0 col-sm-8">
                  <h2 class="subHeading">Second Carrers</h2>
                  <hr />
                  <p class="witworkstreamTxtBound text-justify">
